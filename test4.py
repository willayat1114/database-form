...
def search_data():
    ...
    if search_term or parameter == "Show All":
        query = ""
        if parameter == "Name":
...
def display_all_data(data):
    ...
    tree = ttk.Treeview(all_data_window, columns=("ID", "Name", "Class", "Stream", "Phone Number", 
                                                  "Father's Name", "Mother's Name", "Parent's Phone", 
                                                  "Permanent Address", "Correspondence Address"), show="headings")
    ...
    tree.heading("Father's Name", text="Father's Name")
    tree.heading("Mother's Name", text="Mother's Name")
    tree.heading("Parent's Phone", text="Parent's Phone")
    tree.heading("Permanent Address", text="Permanent Address")
    tree.heading("Correspondence Address", text="Correspondence Address")
    ...
    tree.column("Father's Name", width=150)
    tree.column("Mother's Name", width=150)
    tree.column("Parent's Phone", width=120)
    tree.column("Permanent Address", width=200)
    tree.column("Correspondence Address", width=200)
...
lookup_menu = ttk.OptionMenu(lookup_frame, lookup_param, "Name", "Name", "ID", "Class", "Stream", "Show All")
